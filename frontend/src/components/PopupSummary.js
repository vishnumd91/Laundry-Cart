      ...
      {(close) => (
        <div className="summary-container-popup-summary">
          <div className="summary-header-popup-summary">
            ...
            <button className="close-btn-popup-summary" onClick={() => close()}>
              X
            </button>
          </div>
          <div className="summary-body-popup-summary">
            <div className="store-details-popup-summary">
              <div className="store-location-popup-summary store-item-popup-summary">
                <p className="store-item-header-popup-summary">
                  Store Location
                </p>
                <p className="store-item-text-popup-summary">
                  {props.order.store_location}
                </p>
              </div>
            ...
            <div className="order-status-popup-summary">
              {props.order.status === "Ready to Pickup" ? (
                <>
                  ...
                  />
                  Picked up
                  <input type="radio" name="Washed" disabled />
                  Washed
                  <input type="radio" name="Ironed" disabled />
                  Ironed
                  <input type="radio" name="Delivered" disabled />
                  Delivered
                </>
              ) : (
                <>
                      ...
                      {props.order.status === "In Ironing" ? (
                        ...
                        <>
                          {props.order.status === "Ready to deliver" ? (
                            ...
                            <>
                              <input type="radio" name="Picked up" disabled />
                              Picked up
                              <input type="radio" name="Washed" disabled />
                              Washed
                              <input type="radio" name="Ironed" disabled />
            ...
            <div
              className="order-details-popup-summary"
              ...
              <table className="table-popup-summary">
                <tbody>
                  {props.order.products.map((product, index) => (
                    <tr>
                      <>
                        <td className="table-item-popup-summary" key={index}>
                          {product.product_type}
                        </td>
                        <td className="table-item-popup-summary">
                          {product.wash_type}
                        </td>
                        <td className="table-item-popup-summary">
                  ...
                  <tr>
                    ...
                    <td className="table-item-popup-summary"></td>
                    <td className="table-item-popup-summary">
                      Sub total: {props?.order?.sub_total}
                    </td>
                  </tr>
                  <tr>
                    <td className="table-item-popup-summary"></td>
                    <td className="table-item-popup-summary"></td>
                    <td className="table-item-popup-summary">
                      Pickup Charges: {props.order?.pickup_charge}
                    </td>
                  </tr>
